...
from booking_grid.cli import main
from booking_grid.models import Note, ProjectState, Task
from booking_grid.cli import demo_state
from booking_grid.storage import load_state, save_state
from booking_grid.models import generate_short_id
from booking_grid.validation import normalize_tags, require_text, validate_task_status
from booking_grid.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
